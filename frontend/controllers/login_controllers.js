...
export class LoginControllers {
    ...
    //render modal signin
    renderSignin() {
        this.renderForm("SignIn", "/api/signin", "username", "password", "Sign In", "Don't have an account?", this.signinSubmitHandler);
    ...
    renderForm(title, action, usernamePlaceholder, passwordPlaceholder, buttonLabel, helpText, submitHandler) {
            ...
            <div class="text-center">
                ...
                <div class="card-body">
                    <form action="${action}" method="post" data-signin>
                        ...
                        <div class="form-group mt-3">
                            <button class="btn btn-success btn-block" >${buttonLabel}</button>
