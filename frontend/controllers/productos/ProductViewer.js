...
<div class="col-md-6">
  ...
  <ul class="list-unstyled mt-3">
    <li><i class="fas fa-check-circle"></i> Envío rápido en 24 horas</li>
    <li><i class="fas fa-check-circle"></i> Garantía de devolución de dinero</li>
    <li><i class="fas fa-check-circle"></i> Atención al cliente 24/7</li>
  </ul>

  ${hayStock ? "" : '<div class="alert alert-warning">Sin stock</div>'}

  <!-- Lógica de selección de talla y notificación -->
  ${
    hayStock
  ...
  ${
    hayStock
      ...
      <button type="button" class="btn btn-primary me-2" data-carrito>Añadir al carrito</button>
