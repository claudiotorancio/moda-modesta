...
export class ProductForm {
  ...
  createForm() {
        ...
        <div class="text-center">
          ...
          <div class="card-body w-100">
            <form id="form" action="/api/createProduct" enctype="multipart/form-data" method="POST" data-form>
              ...
              <div class="form-group mb-4" id="sizesContainer">
                <div class="form-row">
    ...
    // Agregar evento para mostrar/ocultar talles
  ...
  toggleSizesVisibility() {
    ...
    // Función para mostrar/ocultar talles
    const updateSizesVisibility = () => {
      if (sectionSelect.value === "opcion3") {
        // Diversos
    ...
    // Agregar evento para el cambio en el select
    sectionSelect.addEventListener("change", updateSizesVisibility);
  }
