...
const compraPrepare = async (req, res) => {
  try {
    ...
    <div style="font-family: Arial, sans-serif; color: #333;">
      ...
      <p>Nos complace informarte que tu pedido con el producto <strong>${producto}</strong> está en proceso de preparación. Pronto recibirás actualizaciones sobre el estado de tu pedido.</p>
